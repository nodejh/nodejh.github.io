+++
title = "在 Atom 中使用 ESlint"
description = "Use eslint-config-airbnb in Atom"
...
ESlint 主要是用来帮助我们规范书写 JavaScript 代码。通过使用 Atom 的 ESLit 插件，并配合 Airbnb 的 ESLint 规则，我们可以一边编码一边检测语法。

<!--more-->

关于 ESLint 的详细介绍可看[官方文档](http://eslint.org)。
...
---
Github Issue: [https://github.com/nodejh/nodejh.github.io/issues/21](https://github.com/nodejh/nodejh.github.io/issues/21)
